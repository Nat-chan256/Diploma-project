(function () {
    ...
    let bloodPressure;
    if (document.getElementsByName("bloodPressure")[0].checked) {
        bloodPressure = document.getElementsByName("bloodPressure")[0].value;
    }
    if (document.getElementsByName("bloodPressure")[1].checked) {
        bloodPressure = document.getElementsByName("bloodPressure")[1].value;
    }
    let familyHistory;
    if (document.getElementsByName("familyHistory")[0].checked) {f
        familyHistory = document.getElementsByName("familyHistory")[0].value;
    }
    if (document.getElementsByName("familyHistory")[1].checked) {
        familyHistory = document.getElementsByName("familyHistory")[1].value;
    }
    let TG;
    ...
    let lowActivity;
    if (document.getElementsByName("lowActivity")[0].checked) {
        lowActivity = document.getElementsByName("lowActivity")[0].value;
    }
    if (document.getElementsByName("lowActivity")[1].checked) {
        lowActivity = document.getElementsByName("lowActivity")[1].value;
    }
    let IGT;
    ...
    let coldSweat;
    if (document.getElementsByName("coldSweat")[0].checked) {
        coldSweat = document.getElementsByName("coldSweat")[0].value;
    }
    if (document.getElementsByName("coldSweat")[1].checked) {
        coldWweat = document.getElementsByName("coldSweat")[1].value;
    }
